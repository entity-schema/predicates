...
export declare const assertObjectSchema: (objectSchema: any) => void;
export declare const assertObjectSchemaProperties: (objectSchema: any) => void;
export declare const assertObjectSchemaProperty: (objectSchema: any, key: string) => void;
